...
export default function ContactPage() {
  ...
  const whatsappNumber = settings.whatsapp_number || "+2348050280248";
  ...
  const nigeriaOfficeAddress = settings.nigeria_office_address || "2 Onola Balemo Quarters, Ado Ekiti";
  const abujaOfficeAddress = settings.abuja_office_address || "No 4, MukB Estate by A. A. Rano Filling Station, along Dape Lifecamp Abuja.";
  const maliOfficeAddress = settings.mali_office_address || "5em plaque, Garantiguibougou, Bamako, Mali";
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="text-gray-700 text-sm whitespace-pre-line">{nigeriaOfficeAddress}</p>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              <h3 className="text-lg font-bold text-gray-900 mb-2">Abuja Office</h3>
              <p className="text-gray-700 text-sm whitespace-pre-line">{abujaOfficeAddress}</p>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              <h3 className="text-lg font-bold text-gray-900 mb-2">Mali Office</h3>
              <p className="text-gray-700 text-sm whitespace-pre-line">{maliOfficeAddress}<br />Phone: {maliOfficePhone}</p>
            </div>
          </div>
