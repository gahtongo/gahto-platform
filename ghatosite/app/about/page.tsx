        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-20 md:py-24 text-center">
          ...
          <div className="mt-10 flex justify-center">
            <button
              ...
              className="inline-flex items-center gap-3 rounded-2xl bg-white px-8 py-4 font-bold text-slate-900 shadow-xl transition hover:bg-gray-100 hover:scale-105 active:scale-95"
            >
